...
from app.services.script_cleaner import _chunk_ocr, _extract_json_array, _normalize_dialogue_text, _normalize_speaker_and_gender
...
def test_normalize_dialogue_text_suppresses_filler_only():
    assert _normalize_dialogue_text("Huuu...") == ""
    assert _normalize_dialogue_text("Haaaa") == ""
