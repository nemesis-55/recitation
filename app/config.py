...
class Settings(BaseSettings):
    ...
    reel_playback_speed: float = Field(default=1.25, alias="REEL_PLAYBACK_SPEED")
    ...
    openai_emotion_refine_max_lines: int = Field(default=12, alias="OPENAI_EMOTION_REFINE_MAX_LINES")
